...
$(function () {
  ...
  var list;
  var shopcart = get();
  var arr = [".television-box", ".fridge-box", ".washer-box", ".electric-box", ".kitchen-box", ".hardware-box", ".house-box", ".mini-box"];
  ...
  function eventBind(ele) {
    $(ele).children(".list-box").on("click", ".setIn-car-btn", function () {
      ...
      save(shopcart); // console.log( shopcart );

      numCart();
    });
  }

  remove(shopcart); //侧边二级导航
